            ...
            <td>
                <label>
                    <select id="wpacu_assets_list_layout"
                        ...
                        <option <?php if ($data['assets_list_layout'] === 'all') { echo 'selected="selected"'; } ?> value="all"><?php _e('All Styles &amp; Scripts', 'wp-asset-clean-up'); ?> &#10230; <?php _e('One list', 'wp-asset-clean-up'); ?></option>
					</select>
				</label>
