...
<p style="margin: 8px 0;"><select id="wpacu_assets_list_layout" style="max-width: inherit;" name="wpacu_assets_list_layout">
    ...
    <option <?php if ($data['plugin_settings']['assets_list_layout'] === 'by-loaded-unloaded') { echo 'selected="selected"'; } ?> value="by-loaded-unloaded"><?php _e('All Styles &amp; Scripts', 'wp-asset-clean-up'); ?> &#10230; <?php _e('Grouped by loaded or unloaded status', 'wp-asset-clean-up'); ?></option>
        <!-- [wpacu_pro] -->
        <option <?php if ($data['plugin_settings']['assets_list_layout'] === 'by-rules') { echo 'selected="selected"'; } ?> value="by-rules"><?php _e('All Styles &amp; Scripts', 'wp-asset-clean-up'); ?> &#10230; <?php _e('Grouped by having at least one rule &amp; no rules', 'wp-asset-clean-up'); ?></option>
        <option <?php if ($data['plugin_settings']['assets_list_layout'] === 'by-size') { echo 'selected="selected"'; } ?> value="by-size"><?php _e('All Styles &amp; Scripts', 'wp-asset-clean-up'); ?> &#10230; <?php _e('Grouped by their size (sorted in descending order)', 'wp-asset-clean-up'); ?></option>
        <!-- [/wpacu_pro] -->

        <option <?php if (in_array($data['plugin_settings']['assets_list_layout'], array('two-lists', 'default'))) { echo 'selected="selected"'; } ?> value="two-lists"><?php _e('All Styles (one list)', 'wp-asset-clean-up'); ?> + <?php _e('All Scripts (one list)', 'wp-asset-clean-up'); ?></option>

        <!-- [wpacu_pro] -->
        <option <?php if ($data['plugin_settings']['assets_list_layout'] === 'all') { echo 'selected="selected"'; } ?> value="all"><?php _e('All Styles &amp; Scripts', 'wp-asset-clean-up'); ?> &#10230; <?php _e('One list', 'wp-asset-clean-up'); ?></option>
        <!-- [/wpacu_pro] -->
</select></p>
<?php
