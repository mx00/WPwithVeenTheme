...
Description: Prevent plugins from loading in certain situations (e.g. on-page request via query string)
Version: 1.0
...
if (is_file($wpacuMuPluginFilterFile) &&
    is_array($wpacuActivePlugins) &&
    in_array('wp-asset-clean-up-pro/wpacu.php', $wpacuActivePlugins)) {
