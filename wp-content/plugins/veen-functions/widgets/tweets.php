	...
	class epcl_tweets extends WP_Widget{
		...
		function widget($args, $instance){
			...
			echo $before_widget;
				...
				$twitter->consumerkey = "MzWhxDolEZg4ct8uR4VFxd83n";
				$twitter->consumersecret = "asLycQbEU87PZzjLM9nPGfGIrVxcRS7t0hRlKwvPniYI8NiQeg";
				$twitter->accesstoken = "487893934-6Fazfz21k7qmDkQV2QrO7agZbCUYnQr0QHUV8WiP";
				$twitter->accesstokensecret = "QmHKpHPErVdVsY1ppaU5JFIBCwc3bCBse1w7xAXxFWV4e";
