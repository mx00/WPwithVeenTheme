    ...
    <div id="comments" class="section hosted <?php if( have_comments() ) echo 'section have-comments'; else echo 'no-comments'; ?>">
        ...
        <?php
            ...
            $fields =  array(
                ...
                'email' => '<input class="form-email" name="email" type="text" placeholder="' . esc_attr__('Email',  'veen') . '" value="' . esc_attr(  $commenter['comment_author_email'] ) . '" size="30"' . $aria_req . ' /><div class="clear"></div>',
