...
<?php if( epcl_get_option('enable_author', true) ): ?>
    ...
    <section id="author" class="author section <?php echo esc_attr($class); ?>">
        <?php if( is_single() ): ?>
            <div class="title medium bordered"><?php esc_html_e('About the Author', 'veen'); ?></div>
        <?php endif; ?>
        <div class="flex">
            ...
            <?php endif; ?>
            <div class="info">
                <div class="title small author-name"><a href="<?php echo esc_attr( $author_url ); ?>"><?php echo esc_attr( $author_name ); ?></a></div>
