...
<div class="grid-container">
    ...
    <div class="row module-wrapper <?php echo esc_attr($module_class); ?>">
        ...
        <?php if( epcl_get_option('enable_breadcrumbs') == '1' && function_exists('epcl_render_breadcrumbs') && !is_front_page() ): ?>
            <div class="epcl-breadcrumbs grid-100 tablet-prefix-5 np-tablet" <?php if( epcl_get_option('breadcrumbs_type') == 'navxt'): ?> typeof="BreadcrumbList" vocab="https://schema.org/" <?php endif; ?>>
