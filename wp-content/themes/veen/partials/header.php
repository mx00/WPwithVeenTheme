        ...
        <div class="menu-wrapper">
            <div class="grid-container">
                ...
                <?php if( epcl_get_option('logo_type') == 1 && !empty($epcl_theme['logo_image']['url']) ): ?>
                    <div class="logo">
                        <a href="<?php echo home_url('/'); ?>"><img src="<?php echo esc_url( $epcl_theme['logo_image']['url'] ); ?>" alt="<?php bloginfo('name'); ?>" width="<?php echo epcl_get_option('logo_width'); ?>" height="<?php echo esc_attr( $epcl_theme['logo_image']['height'] ); ?>"></a>
                    </div>
                    <?php if( !empty($epcl_theme['sticky_logo_image']['url']) ): ?>
                        <div class="logo sticky-logo">
                            <a href="<?php echo home_url('/'); ?>"><img src="<?php echo esc_url( $epcl_theme['sticky_logo_image']['url'] ); ?>" alt="<?php bloginfo('name'); ?>" width="<?php echo epcl_get_option('sticky_logo_width'); ?>" height="<?php echo esc_attr( $epcl_theme['sticky_logo_image']['height'] ); ?>"></a>
                        </div>                
                    <?php endif; ?>
                <?php else: ?>
